# Copy Oficial — Masterclass "A Morte da Consultoria Artesanal"

Este é o texto aprovado pelo cliente. Usar EXATAMENTE como está, sem alterar a copy. Apenas formatar em HTML.
...
**Badge:** 🔴 VAGAS LIMITADAS — MASTERCLASS GRATUITA
...
- Subtexto: "Ao vivo e sem replay"

---

## BLOCO DE TENSÃO (Seção 2)

**H2:**
Se o seu faturamento depende de você,
seu crescimento já tem um teto.

**Lista de dores (cards):**
...
**Imagem coluna direita:** evolutto masterclass .webp (cemitério de consultores)

---

## SOLUÇÃO / O QUE VAI APRENDER (Seção 3)
...
**Imagem coluna direita:** evolutto masterclass.webp (split cemitério P&B / consultor tech)

---

## CTA FINAL (Seção 4)

Repetir formulário ou smooth scroll para o hero.
Adicionar urgência máxima:
- Countdown
- Vagas restantes
- "+X consultores já garantiram vaga"
...
2. ⬜ Entrar no grupo do WhatsApp
3. ⬜ Salvar na agenda

**Card WhatsApp:**
"Entre no grupo exclusivo para receber materiais, links e atualizações antes do evento."

**Card Agenda:**
"Salve na sua agenda — não perca a data!"
- Botão Google Calendar
- Botão Outlook/Apple Calendar
